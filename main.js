...
},{"hbsfy/runtime":10}],2:[function(require,module,exports){
require('./helpers.js');
var tpl = require('./tpl.hbs');

document.getElementById('content').innerHTML = tpl({ name: 'Steve'});

},{"./helpers.js":1,"./tpl.hbs":11}],3:[function(require,module,exports){
"use strict";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<h1>Hello, "
    + escapeExpression((helper = helpers.uc || (depth0 && depth0.uc),options={hash:{},data:data},helper ? helper.call(depth0, (depth0 && depth0.name), options) : helperMissing.call(depth0, "uc", (depth0 && depth0.name), options)))
    + "</h1>\n";
  return buffer;
  });
